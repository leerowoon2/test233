...
+function ($) {
	...
	$.notify = function(message, options) {
		...
		var $elem = $("<div data-animation='"+animation+"' class='notify "+config.align+" "+ config.verticalAlign+" "+animation+" "+closeClass+"'><div class='notifyMessage'>"+icon+message+"</div>"+buttons+close+"</div>");
