...
var Sketch = function(config) { 'use strict';
	...
	var layer1 = layer[1];
	var layer2 = layer[2];
	layer0.className = "kk_sketch_bg";
	layer1.className = "kk_sketch_overlay";
	layer2.className = "kk_sketch_active";
	var ctx0 = layer2d[0];
	var ctx1 = layer2d[1];
	var ctx2 = layer2d[2];
	...
	this.record = function(event) {
		...
		eventjs.proxy.drag({
			...
			listener: function(event, self) {
				...
				///
				var coords = {};
				coords.x = (self.x * 1.0 / that.zoom) - $("#editView").scrollLeft();
				coords.y = (self.y * 1.0 / that.zoom) - $("#editView").scrollTop();
				///
